...
| `ARDUINO_APP_CLI__PLATFORM_VERSION_CONSTRAINT` | `<2.0.0`                                        | Semver constraint that limits the version of the Arduino platform installed and offered as an update                                                                                                 |
