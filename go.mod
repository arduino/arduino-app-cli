...
// Required until https://github.com/arduino/arduino-cli/pull/3019 is released
replace github.com/arduino/arduino-cli => github.com/cmaglie/arduino-cli v0.0.0-20251203131956-2d12579cc316
