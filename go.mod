...
require (
	...
	github.com/arduino/go-serial-utils v0.1.4 // indirect
	github.com/arduino/go-timeutils v1.0.0 // indirect
	github.com/arduino/go-win32-utils v1.0.1 // indirect
	github.com/arduino/licensed-notice-deduplicate v1.0.0 // indirect
	github.com/arduino/pluggable-discovery-protocol-handler/v2 v2.2.4 // indirect
