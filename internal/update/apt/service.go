...
func (s *Service) ListUpgradablePackages(ctx context.Context, cfg config.Configuration, matcher func(update.UpgradablePackage) bool) ([]update.UpgradablePackage, error) {
	if !s.lock.TryLock() {
