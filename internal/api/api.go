...
func NewHTTPRouter(
	...
	mux.Handle("POST /v1/apps/{appID}/build", handlers.HandleAppBuild(dockerClient, provisioner, idProvider, cfg))
	mux.Handle("GET /v1/apps/{appID}/build/{artifactID}", handlers.HandleAppBuildArtifact(idProvider, cfg))
