# imageclassification API Reference
...
#### `ImageClassification.classify_from_file(image_path: str, confidence: float)`
...
#### `ImageClassification.classify(image_bytes, image_type: str, confidence: float)`
...
#### `ImageClassification.process(item)`
