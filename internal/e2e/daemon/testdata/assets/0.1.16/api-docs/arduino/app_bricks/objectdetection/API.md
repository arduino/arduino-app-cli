...
#### `ObjectDetection.detect_from_file(image_path: str, confidence: float)`
...
#### `ObjectDetection.detect(image_bytes, image_type: str, confidence: float)`
...
#### `ObjectDetection.draw_bounding_boxes(image: Image.Image | bytes, detections: dict)`
