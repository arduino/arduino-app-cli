...
```python
class CloudLLM(api_key: str, model: Union[str, CloudModel], system_prompt: str, temperature: Optional[float], max_tool_loops: int, timeout: int, tools: List[Callable[..., Any]], callbacks: Any)
```
