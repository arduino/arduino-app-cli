...
func GetExamples(cfg config.Configuration, idProvider *app.IDProvider) (ExampleResponse, error) {
...
func retrieveExamplesInfo(examples []Example, idProvider *app.IDProvider) {
