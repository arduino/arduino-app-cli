...
#### `SQLStore.create_table(table: str, columns: dict[str, str])`
...
#### `SQLStore.store(table: str, data: dict[str, Any], create_table: bool)`
...
#### `SQLStore.read(table: str, columns: Optional[list], condition: Optional[str], order_by: Optional[str], limit: Optional[int])`
...
#### `SQLStore.update(table: str, data: dict[str, Any], condition: Optional[str])`
...
#### `SQLStore.delete(table: str, condition: Optional[str])`
...
#### `SQLStore.execute(sql: str, args: Optional[tuple])`
...
#### `SQLStore.create_or_replace_table(table: str, columns: dict[str, str], force_drop_table: bool)`
