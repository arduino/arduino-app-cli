...
#### `CameraCodeDetector.on_detect(callback: Callable[[Image, Detection], None] | None)`
...
#### `CameraMultiCodeDetector.on_detect(callback: Callable[[Image, list[Detection]], None] | None)`
