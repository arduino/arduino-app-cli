...
#### `TimeSeriesStore.write_sample(measure: str, value: Any, ts: int, measurement_name: str)`
...
#### `TimeSeriesStore.read_last_sample(measure: str, measurement_name: str, start_from: str)`
...
#### `TimeSeriesStore.read_samples(measure: str, measurement_name: str, start_from: str, end_to: str, aggr_window: str, aggr_func: str, limit: int, order: str)`
