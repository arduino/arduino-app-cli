...
#### `WeatherForecast.get_forecast_by_city(city: str, timezone: str, forecast_days: int)`
...
#### `WeatherForecast.get_forecast_by_coords(latitude: str, longitude: str, timezone: str, forecast_days: int)`
